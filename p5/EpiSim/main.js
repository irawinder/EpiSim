...
function ViewAttributes() {
  ...
  this.getColor = function(e) {
    if(this.viewColor.hasOwnProperty(e)) {
  ...
  this.getName = function(e) {
    if(this.viewName.hasOwnProperty(e)) {
  ...
  this.getValue = function(e) {
    if(this.viewValue.hasOwnProperty(e)) {
  ...
  this.getToggle = function(e) {
    if(this.viewToggle.hasOwnProperty(e)) {
...
const ViewParameter = {
  ...
  ENVIRONMENT_DIAMETER: 'ENVIRONMENT_DIAMETER', 
